...
<body>
		...
		<div class="row">
			<div class="col-md-10 col-xs-12">
				<div class='ys_top_title'>
					<h1><a target="_blank" href="javascript:void(0);">YUESHI CHINA</a></h1>
				</div>
				...
				?>
			        ...
			        foreach ($focus_list as $k=>$v){
						if($k==0){
							echo '<div class="item active"><div class="ys_focus_mask"><a href="'.$v['f_link'].'"><div class="ys_focus_center"><div class="ys_focus_center_inner"><p>'.$v['f_title'].'</p><p>点击前往品鉴</p><p>——</p><p>More Info</p></div></div></a></div>';
						}else{
							echo '<div class="item"><div class="ys_focus_mask"><a href="'.$v['f_link'].'"><div class="ys_focus_center"><div class="ys_focus_center_inner"><p>'.$v['f_title'].'</p><p>点击前往品鉴</p><p>——</p><p>More Info</p></div></div></a></div>';
						}
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$('.carousel-inner').hover(function(e){
				$(".active .ys_focus_mask").show();
			}, function(e){
				$(".active .ys_focus_mask").hide();
			});

      				...
      				<div class="ys_article_stat">
      					...
      					<p>
      						...
      						<button type="button" class="btn btn-default btn-xs ys_like">
								<span class="glyphicon glyphicon-heart" aria-hidden="true"></span> 喜欢 <em><?php echo $like; ?></em>
							</button>
      						<button type="button" class="btn btn-default btn-xs ys_fav">
								<span class="glyphicon glyphicon-star" aria-hidden="true"></span> 收藏 <em><?php echo $fav; ?></em>
							</button>
      					</p>
      				</div>
      				...
      				<div class="ys_article_related">
      					...
      					<div class="ys_container">
      						...
      						foreach ($related_article as $k=>$v){
								...
								$html .= '<a target="_blank" href="/article/detail/'.$v['id'].'"><img src="' . $v['cover'] . '" /></a>';
								$html .= '<div class="ys_caption"><h3><a target="_blank" href="/article/detail/' . $v['id'] . '">' . $v['name'] . '</a></h3></div></div></div>';
								$count++;
								if($count>2) break;
							}

...
class Video_Model extends MY_Model {
	...
	public $fields = array(
			...
			array('name'=>'v_title', 'comment'=>'视频名称', 'type'=> array('name'=>'text'), 'validation'=>array('required') ),
			array('name'=>'v_category', 'comment'=>'视频分类'),
			array('name'=>'v_desc', 'comment'=>'视频简介'),
			array('name'=>'v_thumb', 'comment'=>'视频缩略图'),
			array('name'=>'v_click', 'comment'=>'访问次数'),
			array('name'=>'v_like', 'comment'=>'喜欢次数'),
			array('name'=>'v_fav', 'comment'=>'收藏次数'),

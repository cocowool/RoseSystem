...
class Focus_Model extends MY_Model {
	...
	public $fields = array(
			...
			array('name'=>'f_title', 'comment'=>'焦点图名称', 'form'=> array('type'=>'text', 'validation'=>'required', 'tips'=>'请输入焦点图名称')),
			array('name'=>'f_desc', 'comment'=>'简介', 'form'=> array('type'=>'textarea', 'validation'=>'required', 'tips'=>'请输入简介')),
			array('name'=>'f_img', 'comment'=>'焦点图', 'form'=> array('type'=>'file', 'validation'=>'required', 'edit'=>'img') ),	//存储WEB访问调用地址
